...
BEFORE_CODE = """
print 'WE ARE ENTERING A NEW FUNCTION'
#GlobalCounterInst.push_current_counter()
GlobalCounterInst.count(file='{file_name}',
                        class_name='{class_name}',
                        method='{method_name}',
                        lineno={lineno})
GlobalCounterInst.print_global_counter()
"""

# We need to inject a new import statement that contains the GlobalCounterInst
IMPORT_CODE = """
from counter import GlobalCounterInst
GlobalCounterInst.init_tracer()
GlobalCounterInst.initialize_call_stack()
"""
...
GlobalCounterInst.to_csv()
GlobalCounterInst.print_global_counter()
#GlobalCounterInst.print_difference()
print "EXITING CODE"
"""
